<?php if (!empty($_SESSION['notify']->errors)) { ?>
    <div class="alert alert-danger fade in">
        ...
        <h4><?= (isset($_SESSION['notify']->title)) ? $_SESSION['notify']->title : $this->__('Error') . '!' ?></h4>
...
<?php } elseif (!empty($_SESSION['notify']->warning)) { ?>
    <div class="alert alert-warning fade in">
        ...
        <h4><?= (isset($_SESSION['notify']->title)) ? $_SESSION['notify']->title : $this->__('Warning') . '!' ?></h4>
...
<?php } elseif (!empty($_SESSION['notify']->success)) { ?>
    <div class="alert alert-success fade in">
        ...
        <h4><?= (isset($_SESSION['notify']->title)) ? $_SESSION['notify']->title : $this->__('Success') . '!' ?></h4>
